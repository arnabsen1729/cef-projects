...
class Todo
  ...
  def to_displayable_string
    ...
    # This function can be broken down into steps like these
    #
    # display_string = "[#{@completed ? "X" : " "}] #{@text}"
    # if @due_date != Date.today
    #   display_string += " #{@due_date.iso8601}"
    # end
    # return display_string

    # Or a one-liner like this
    "[#{@completed ? "X" : " "}] #{@text} #{@due_date != Date.today ? @due_date.iso8601 : ""}"
  end
end
